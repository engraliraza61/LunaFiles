...
{
    public partial class Counslate
    {
        public Counslate()
        {
            CounslateVisaFormTemplate = new HashSet<CounslateVisaFormTemplate>();
        ...
        public virtual ICollection<CounslateVisaFormTemplate> CounslateVisaFormTemplate { get; set; }
