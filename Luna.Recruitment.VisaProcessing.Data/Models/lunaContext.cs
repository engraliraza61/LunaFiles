...
namespace Luna.Recruitment.VisaProcessing.Data.Models
{
    public partial class lunaContext : DbContext
    {
        ...
        public virtual DbSet<AssignTestCenterToPermission> AssignTestCenterToPermission { get; set; }
        public virtual DbSet<CandidateProfile> CandidateProfile { get; set; }
        public virtual DbSet<CandidateBulkSelection> CandidateBulkSelection { get; set; }
        public virtual DbSet<SelectionAddCandidateMaster> SelectionAddCandidateMaster { get; set; }
        ...
        public virtual DbSet<SelectionQtyDetail> SelectionQtyDetail { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=Luna;User Id=sa;Password=Abcd@1234;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OepvisaDemand>(entity =>
            {
                ...
                entity.Property(e => e.VisaNumberDate)
                    .IsRequired()
                    .HasMaxLength(50);
                ...
                entity.HasOne(d => d.OepvisaDemandStatusEntitySetup)
                    .WithMany(p => p.OepvisaDemand)
                    .HasForeignKey(d => d.OepvisaDemandStatusEntitySetupId)
