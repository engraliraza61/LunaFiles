...
{
    public class IdentityManagersController : Controller
    {
        ...
        public IdentityManagersController(UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager, ILogger<IdentityManagersController> logger)
        {
