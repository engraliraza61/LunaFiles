...
namespace Luna.Recruitment.VisaProcessing.Web.Controllers
{
    public class DashboardController : Controller
    {
            ...
            public DashboardController(UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager, ILogger<DashboardController> logger)
            {
            ...
            public IActionResult DashboardUserList()
            {
            ...
            public IActionResult DashboardUserRoles()
            {
                ViewBag.ClaimTypes = _claimTypes.Keys.OrderBy(s => s);
                return View();
            }
